...
import "./createNewPurchaseBillBook.css";
...
export default function CreateNewPurchaseBillBook() {
  ...
  return (
    <>
      <div className="createNewPurchaseBillBook-container">
        <form onSubmit={handleSendInvoiceState}>
          <div className="createNewPurchaseBillBook-head">
            <nav>
              ...
              {invoiceStatus !== "" && (
                <h3
                  className={
                    invoiceStatus === "Draft"
                      ? "createNewPurchaseBillBook-Status-draft"
                      : invoiceStatus === "Send"
                      ? "createNewPurchaseBillBook-Status-Send"
                      : invoiceStatus === "Paid"
                      ? "createNewPurchaseBillBook-Status-Paid"
                      : invoiceStatus === "Cancelled"
                      ? "createNewPurchaseBillBook-Status-Cancelled"
                      : "createNewPurchaseBillBook-Status-empty"
                  }
                >
            ...
            <div>
              <button
                className={
                  invoiceStatus === "Send" || invoiceStatus === "Paid"
                    ? "createNewPurchaseBillBook-active-btn"
                    : "createNewPurchaseBillBook-inactive-btn"
                }
              ...
              <nav
                className="createNewPurchaseBillBook-close"
                onClick={(e) => {
                  e.preventDefault();
                  prevpg(-1);
                }}
              >
                <svg
                  className="createNewPurchaseBillBook-circle-x-logo"
          ...
          <div className="createNewPurchaseBillBook-input-container">
            <div className="createNewPurchaseBillBook-input-box">
          ...
          <nav className="createNewPurchaseBillBook-subtit">Customer Information</nav>
          <div className="createNewPurchaseBillBook-input-container">
            <div className="createNewPurchaseBillBook-input-box">
          ...
          <div className="createNewPurchaseBillBook-input-box contact-person-halfwidth">
          ...
          <nav className="createNewPurchaseBillBook-subtit">Line Items</nav>
          <div className="createNewPurchaseBillBook-table-container">
            <table>
              <thead className="createNewPurchaseBillBook-table-head">
                <tr>
                  <th>#</th>
                  <th>
              ...
              <tbody className="createNewPurchaseBillBook-table-body">
          ...
          <div className="createNewPurchaseBillBook-hub-container">
            <div className="createNewPurchaseBillBook-hub-head">
              <p
                className={
                  detail.comment
                    ? "createNewPurchaseBillBook-hub-head-bg-black"
                    : "createNewPurchaseBillBook-hub-head-tit"
                }
                onClick={() => {
                  setDetail({
                    history: false,
            ...
            <div className="createNewPurchaseBillBook-hub-body">
              {detail.comment && <InvoiceComment />}
              {detail.history && <InvoiceHistory />}
              {detail.attachment && <InvoiceAttachment />}
            </div>
          </div>
          <div className="createNewPurchaseBillBook-btn-container">
            <button
              className={
                invoiceStatus === "Send" || invoiceStatus === "Paid"
                  ? "createNewPurchaseBillBook-order-active-btn"
                  : "createNewPurchaseBillBook-inactive-btn"
              }
            ...
            <nav>
              <button
                className="createNewPurchaseBillBook-cancel-btn"
                onClick={(e) => {
                  e.preventDefault();
                  prevpg(-1);
                }}
              ...
              <button
                className={
                  invoiceStatus === "" || invoiceStatus === "Draft"
                    ? "createNewPurchaseBillBook-active-btn"
                    : "createNewPurchaseBillBook-completed-btn"
                }
              ...
              <svg
                className={
                  invoiceStatus !== ""
                    ? "createNewPurchaseBillBook-pdf-mail-activelogo"
                    : "createNewPurchaseBillBook-pdf-mail-futurelogo"
                }
